  ...
  return (
    <div className="bg-white shadow overflow-hidden sm:rounded-lg mb-6">
      ...
      <div className="border-t border-gray-200 px-4 py-5 sm:p-6 flex flex-col items-center">
        ...
        <button
          onClick={onReloadQR}
          className="mt-4 inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md shadow-sm text-white bg-blue-700 hover:bg-blue-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500"
        >
          Recargar QR
        </button>
      </div>
